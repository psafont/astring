...
let cut = test "String.cut" @@ fun () ->
  ...
  let empty = false in
  app_invalid ~pp:ppp (String.cut ~empty ~sep:"") "";
  app_invalid ~pp:ppp (String.cut ~empty ~sep:"") "123";
  eqo (String.cut ~rev ~sep:"," "") None;
  eqo (String.cut ~empty ~sep:"," "")  None;
  eqo (String.cut ~empty ~sep:"," ",") None;
  eqo (String.cut ~empty ~sep:"," ",,") None;
  eqo (String.cut ~empty ~sep:"," ",,,") None;
  eqo (String.cut ~empty ~sep:"," "123") None;
  eqo (String.cut ~empty ~sep:"," ",123") None;
  eqo (String.cut ~empty ~sep:"," "123,") None;
  eqo (String.cut ~empty ~sep:"," "1,2,3") (Some ("1", "2,3"));
  eqo (String.cut ~empty ~sep:"," " 1,2,3") (Some (" 1", "2,3"));
  eqo (String.cut ~empty ~sep:"<>" "") None;
  eqo (String.cut ~empty ~sep:"<>" "<>") None;
  eqo (String.cut ~empty ~sep:"<>" "<><>") None;
  eqo (String.cut ~empty ~sep:"<>" "<><><>") None;
  eqo (String.cut ~empty ~rev ~sep:"<>" "1") None;
  eqo (String.cut ~empty ~sep:"<>" "123") None;
  eqo (String.cut ~empty ~sep:"<>" "<>123") None;
  eqo (String.cut ~empty ~sep:"<>" "123<>") None;
  eqo (String.cut ~empty ~sep:"<>" "1<>2<>3") (Some ("1", "2<>3"));
  eqo (String.cut ~empty ~sep:"<>" " 1<>2<>3") (Some (" 1", "2<>3"));
  eqo (String.cut ~empty ~sep:"<>" ">>><>>>><>>>><>>>>") (Some (">>>", ">>><>>>><>>>>"));
  eqo (String.cut ~empty ~sep:"<->" "<->>->") None;
  eqo (String.cut ~empty ~rev ~sep:"<->" "<-") None;
  eqo (String.cut ~empty ~sep:"aa" "aa") None;
  eqo (String.cut ~empty ~sep:"aa" "aaa") None;
  eqo (String.cut ~empty ~sep:"aa" "aaaa") None;
  eqo (String.cut ~empty ~sep:"aa" "aaaaa") None;
  eqo (String.cut ~empty ~sep:"aa" "aaaaaa") None;
  eqo (String.cut ~sep:"ab" "faaaa") None;
  app_invalid ~pp:ppp (String.cut ~rev ~empty ~sep:"") "";
  app_invalid ~pp:ppp (String.cut ~rev ~empty ~sep:"") "123";
  eqo (String.cut ~rev ~empty ~sep:"," "") None;
  eqo (String.cut ~rev ~empty ~sep:"," ",") None;
  eqo (String.cut ~rev ~empty ~sep:"," ",,") None;
  eqo (String.cut ~rev ~empty ~sep:"," ",,,") None;
  eqo (String.cut ~rev ~empty ~sep:"," "123") None;
  eqo (String.cut ~rev ~empty ~sep:"," ",123") None;
  eqo (String.cut ~rev ~empty ~sep:"," "123,") None;
  eqo (String.cut ~rev ~empty ~sep:"," "1,2,3") (Some ("1,2", "3"));
  eqo (String.cut ~rev ~empty ~sep:"," "1,2,3 ") (Some ("1,2", "3 "));
  eqo (String.cut ~rev ~empty ~sep:"<>" "") None;
  eqo (String.cut ~rev ~empty ~sep:"<>" "<>") None;
  eqo (String.cut ~rev ~empty ~sep:"<>" "<><>") None;
  eqo (String.cut ~rev ~empty ~sep:"<>" "<><><>") None;
  eqo (String.cut ~rev ~empty ~sep:"<>" "1") None;
  eqo (String.cut ~rev ~empty ~sep:"<>" "123") None;
  eqo (String.cut ~rev ~empty ~sep:"<>" "<>123") None;
  eqo (String.cut ~rev ~empty ~sep:"<>" "123<>") None;
  eqo (String.cut ~rev ~empty ~sep:"<>" "1<>2<>3") (Some ("1<>2", "3"));
  eqo (String.cut ~rev ~empty ~sep:"<>" "1<>2<>3 ") (Some ("1<>2", "3 "));
  eqo (String.cut ~rev ~empty ~sep:"<>" ">>><>>>><>>>><>>>>")
    (Some (">>><>>>><>>>>", ">>>"));
  eqo (String.cut ~rev ~empty ~sep:"<->" "<->>->") None;
  eqo (String.cut ~rev ~empty ~sep:"<->" "<-") None;
  eqo (String.cut ~rev ~empty ~sep:"aa" "aa") None;
  eqo (String.cut ~rev ~empty ~sep:"aa" "aaa") None;
  eqo (String.cut ~rev ~empty ~sep:"aa" "aaaa") None;
  eqo (String.cut ~rev ~empty ~sep:"aa" "aaaaa") None;
  eqo (String.cut ~rev ~empty ~sep:"aa" "aaaaaa") None;
  eqo (String.cut ~rev ~empty ~sep:"ab" "afaaaa") None;
  ()
